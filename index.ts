...
class TimeBar {
    ...
    #draw() {
        ...
        for (let i=0; i<this.pianoRoll.beatDrawCount; i++) {
            if (i%4 === 0) {
                ctx.beginPath();
                ctx.moveTo(i*this.pianoRoll.config.beatWidth, this.height / 3);
                ctx.lineTo(i*this.pianoRoll.config.beatWidth, this.height);
                ctx.stroke();
                ...
                timeLabel.style.width = this.pianoRoll.config.beatWidth * 4 + "px";
                timeLabel.style.height = this.height + "px";
                timeLabel.style.left = i*this.pianoRoll.config.beatWidth + "px";
